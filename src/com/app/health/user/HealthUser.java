...
public class HealthUser implements User, Serializable {
	...
	private transient final Logger logger = ESAPI.getLogger("HealthUser");
	 ...
	 */
	public HealthUser(String accountName) {

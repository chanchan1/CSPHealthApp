package com.app.health.security;
...
public class MyFileBasedAuthenticator extends AbstractAuthenticator {
    ...
    public static Authenticator getInstance()
    {
        if ( singletonInstance == null ) {
            synchronized ( MyFileBasedAuthenticator.class ) {
                if ( singletonInstance == null ) {
                    singletonInstance = new MyFileBasedAuthenticator();
                }
            }
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        MyFileBasedAuthenticator auth = new MyFileBasedAuthenticator();
     ...
     *
     */
    private MyFileBasedAuthenticator() {
    	super();
    }
